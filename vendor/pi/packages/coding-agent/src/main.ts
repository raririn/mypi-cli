...
export async function main(args: string[], options?: MainOptions) {
	...
	if (await handlePackageCommand(args, { extensionFactories: commandExtensionFactories })) {
	...
	if (await handleConfigCommand(args, { extensionFactories: commandExtensionFactories })) {
		return;
	}
