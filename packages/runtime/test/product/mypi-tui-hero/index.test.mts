...
import pizzaHeroExtension, {
  PizzaHeroComponent,
  RESOURCE_COMMANDS,
} from "../../../src/product/tui-hero/index.ts";
import { pickNewThreadGreeting } from "../../../src/product/tui-hero/greetings.ts";
...
setKeybindings(new KeybindingsManager({
  ...
  "app.safety.cycle": { defaultKeys: "shift+tab" },
  "app.thinking.cycle": { defaultKeys: [] },
