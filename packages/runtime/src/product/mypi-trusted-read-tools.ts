...
const MYPI_SUBAGENT_READ_TOOLS = new Set(["subagent_start", "consult_advisor", "ask_for_review", "subagent_followup", "subagent_cancel", "subagent_status", "advisor_evidence"]);
