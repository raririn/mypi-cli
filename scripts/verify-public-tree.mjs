...
assert(manifest.version === "2.0.0-beta.10", "repository root has unexpected version");
...
assert(manifest.mypiRelease?.protocol === 2, "repository root has unexpected protocol generation");
