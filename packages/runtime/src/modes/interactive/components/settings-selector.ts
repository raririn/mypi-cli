...
export interface SettingsCallbacks {
	...
	onServiceTierChange: (tier: "default" | "priority") => void;
	...
	constructor(config: SettingsConfig, callbacks: SettingsCallbacks) {
		...
		const items: SettingItem[] = [
			...
			},
			{
				id: "service-tier",
				label: "Service tier",
				description: "Default or priority processing for models that support it",
				currentValue: config.serviceTier,
		...
		this.settingsList = new SettingsList(
			...
			(id, newValue) => {
				switch (id) {
					...
					case "service-tier":
						callbacks.onServiceTierChange(newValue as "default" | "priority");
						break;
					case "hide-thinking":
