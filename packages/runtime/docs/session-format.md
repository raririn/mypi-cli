...
- [`packages/runtime/src/core/session-manager.ts`](https://github.com/earendil-works/pi-mono/blob/main/packages/runtime/src/core/session-manager.ts) - Session entry types and SessionManager
- [`packages/runtime/src/core/messages.ts`](https://github.com/earendil-works/pi-mono/blob/main/packages/runtime/src/core/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
