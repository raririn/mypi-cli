...
import { isTrustedReadOnlyTool, isTrustedUserInteractionTool, isTrustedWebReadTool } from "./mypi-trusted-read-tools.ts";
...
- Provenance-verified sealed MyPi ask_user for non-mutating clarification
