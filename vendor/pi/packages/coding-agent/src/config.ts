...
function getReferenceDir(): string {
	...
	if (typeof resourcesPath === "string") {
		const bundledReferenceDir = join(resourcesPath, "mypi-pi-reference");
		if (existsSync(join(bundledReferenceDir, "README.md"))) {
			return bundledReferenceDir;
		}
	}
...
export function getReadmePath(): string {
	return resolve(join(getReferenceDir(), "README.md"));
}

/** Get path to docs directory */
export function getDocsPath(): string {
	return resolve(join(getReferenceDir(), "docs"));
}

/** Get path to examples directory */
export function getExamplesPath(): string {
	return resolve(join(getReferenceDir(), "examples"));
}
