...
import safemodeExtension from "../../src/product/mypi-safemode.ts";
...
function harness() {
  ...
  const tools = [
    ...
    { name: "web_search", sourceInfo: { path: "<product:capability:web>", source: "product", scope: "temporary", origin: "top-level", productClass: "capability" } },
    { name: "web_fetch", sourceInfo: { path: "<product:capability:web>", source: "product", scope: "temporary", origin: "top-level", productClass: "capability" } },
  ];
  let selections = 0;
  const pi = {
